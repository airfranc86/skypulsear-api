...
class ModelComparisonService:
    ...
    def __init__(self, repositories: Dict[str, IWeatherRepository]):
        ...
        logger.info(f"ModelComparisonService inicializado con {len(repositories)} repositorios")
    ...
    def compare_models_forecast(
        ...
        for model_name, repository in self.repositories.items():
            try:
                ...
                logger.info(f"Pronóstico obtenido de {model_name}: {len(forecast)} puntos")
    ...
    def get_model_summary_metrics(
        ...
        for model_name, model_metrics in verification_results.items():
            ...
            summary[model_name] = {
                ...
                "avg_bias": sum(bias_values) / len(bias_values) if bias_values else None,
